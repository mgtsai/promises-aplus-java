 ...
 */
public interface RejectPromise2<R1, R2>
{
    //-----------------------------------------------------------------------------------------------------------------
    /**
     ...
     */
    public abstract void reject(final R1 r1, final R2 r2, final Throwable e);
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Rejects the target promise.
     *
     ...
     * @param r2 The 2nd reason which the target promise would be rejected with
     */
    public abstract void reject(final R1 r1, final R2 r2);
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Rejects the target promise.
     *
