 ...
 */
public interface RejectPromise4<R1, R2, R3, R4>
{
    //-----------------------------------------------------------------------------------------------------------------
    /**
     ...
     */
    public abstract void reject(final R1 r1, final R2 r2, final R3 r3, final R4 r4, final Throwable e);
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Rejects the target promise.
     *
     ...
     * @param r4 The 4th reason which the target promise would be rejected with
     */
    public abstract void reject(final R1 r1, final R2 r2, final R3 r3, final R4 r4);
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Rejects the target promise.
     *
