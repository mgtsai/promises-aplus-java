...
//---------------------------------------------------------------------------------------------------------------------
/**
 * Defines penta-argument functions with return value.
 *
 ...
 */
public interface FR5<A1, A2, A3, A4, A5, R>
{
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Calls this function.
     ...
     */
    public abstract R call(final A1 a1, final A2 a2, final A3 a3, final A4 a4, final A5 a5) throws Throwable;
    //-----------------------------------------------------------------------------------------------------------------
}
//---------------------------------------------------------------------------------------------------------------------
